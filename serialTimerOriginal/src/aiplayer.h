...
class AIPlayer: public ChessPlayer {
	...
	public:
		...
		*/
		bool getMove(ChessBoard & board, Move & move, int* nodeCount) const;
		...
		*/ 
		int evalAlphaBeta(ChessBoard & board, int color, int depth, int alpha, int beta, bool quiescent, int* nodeCount) const;
