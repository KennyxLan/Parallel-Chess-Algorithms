...
void Move::print(char mesg[]) const {
	...
	if(IS_BLACK(figure)) {
		printf("   Black ");
		sprintf(mesg, "%s", "Black ");
	}
	else {
		printf("   White ");
		sprintf(mesg, "%s", "White ");
	}

	switch(FIGURE(figure)) {
		case PAWN:
			printf("pawn ");
			sprintf(mesg, "%s%s", mesg, "pawn ");
			break;
		case ROOK:
			printf("rook ");
			sprintf(mesg, "%s%s", mesg, "rook ");
			break;
		case KNIGHT:
			printf("knight ");
			sprintf(mesg, "%s%s", mesg, "knight ");
			break;
		case BISHOP:
			printf("bishop ");
			sprintf(mesg, "%s%s", mesg, "bishop ");
			break;
		case QUEEN:
			printf("queen ");
			sprintf(mesg, "%s%s", mesg, "queen ");
			break;
		case KING:
			printf("king ");
			sprintf(mesg, "%s%s", mesg, "king ");
			break;
	}
	
	printf("from %s to %s:\n", field_name[(int)from], field_name[(int)to]);
	sprintf(mesg, "%sfrom %s to %s", mesg, field_name[(int)from], field_name[(int)to]);
}
