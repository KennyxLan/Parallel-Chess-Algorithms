...
bool AIPlayer::getMove(ChessBoard & board, Move & move, int* nodeCount) const
{
	list<Move> regulars, nulls;
	vector<Move> candidates;
    bool quiescent = false;
...
int AIPlayer::evalAlphaBeta(ChessBoard & board, int color, int search_depth, int alpha, int beta, bool quiescent, int* nodeCount) const
{
	list<Move> regulars, nulls;
	int best, tmp;
